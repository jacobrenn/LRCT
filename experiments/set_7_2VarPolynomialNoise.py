...
if __name__ == '__main__':
    ...
    for prop in [0.1, 0.2, 0.3]:
        ...
        plt.title(
            f'Training Data, Experiment 7, Noise Level {prop}', fontsize='xx-large')
        ...
        plt.xlim(-0.5, 5.5)
        plt.ylim(-0.5, 20.5)
        plt.savefig(f'exp7/exp_7_training_{prop}.png')
        ...
        try:
            ...
            plt.title(
                f'LRCT Learned Decision Boundary, Experiment 7, Noise Level {prop}', fontsize='xx-large')
            plt.xlabel('Feature 1', fontsize='x-large')
            plt.ylabel('Feature 2', fontsize='x-large')
            plt.xticks(fontsize='large')
            plt.yticks(fontsize='large')
            plt.xlim(-0.5, 5.5)
            plt.ylim(-0.5, 20.5)
            plt.savefig(f'exp7/exp7_learned_{prop}.png')
        except:
            pass
