...
if __name__ == '__main__':
    ...
    for prop in [0.1, 0.2, 0.3]:
        ...
        plt.title(f'Training Data, Experiment 8, Noise Level {prop}', fontsize = 'xx-large')
        ...
        # Train the models
        lrct = LRCTree(max_depth = 1, highest_degree = 3, n_bins = 20).fit(x_train, y_train_exp)
        ...
        try:
            ...
            plt.title(f'LRCT Learned Decision Boundary, Experiment 8, Noise Level {prop}', fontsize = 'xx-large')
            plt.xlabel('Feature 1', fontsize = 'x-large')
            plt.ylabel('Feature 2', fontsize = 'x-large')
            plt.xticks(fontsize = 'large')
            plt.yticks(fontsize = 'large')
